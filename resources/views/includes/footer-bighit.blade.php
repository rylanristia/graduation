<footer class="fixed-bottom px-4">
    <div class="footer-content align-items-center justify-content-around my-auto">
        <div class="row">
            <div class="col-4">
            ...
            <div class="col-4 family-site">
                <div class="family-inner">
                    <button type="button">FAMILY SITE</button>
                </div>
            </div>
            <div class="col-4">
                <p class="text-footer-1">FAMILY SITE</p>
                <p class="text-footer-2">COPYRIGHT © 2022 BIG HIT MUSIC / HYBE. ALL RIGHTS RESERVED</p>
            </div>
        </div>
    </div>
</footer>
